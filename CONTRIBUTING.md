Contributing to Peony Client
============================

The Peony Client project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the peony unit tests or QA tests
...
The following applies to code changes to the Peony Client project, and is not to be
confused with overall peony Network Protocol consensus changes.

Whether a pull request is merged into Peony Client rests with the project merge
...
Where a patch set proposes to change the peony consensus, it must have been
...
The project leader is the release manager for each Peony Client release.
