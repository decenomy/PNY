...
class RawTransactionsTest(PnyTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid pny address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid pny address" in e.error['message'])
