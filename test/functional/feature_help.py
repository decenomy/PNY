...
"""Verify that starting pny with -h works as expected."""
import subprocess

from test_framework.test_framework import PnyTestFramework
from test_framework.util import assert_equal

class HelpTest(PnyTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pny with -h for help text")
        ...
        self.log.info("Start pny with -version for version information")
