...
class BudgetProposalTest(PnyTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid PNY address")
        assert_raises_rpc_error(-5, "Invalid PNY address", self.nodes[0].preparebudget,
