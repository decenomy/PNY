...
from fake_stake.base_test import PNY_FakeStakeTest

class zPNYwrappedSerialsTest(PNY_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPNYs..." % DENOM_TO_USE)
