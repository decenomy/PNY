...
extern const char * const PNY_CONF_FILENAME;
extern const char * const PNY_PID_FILENAME;
extern const char * const PNY_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("pny-%s", name);
