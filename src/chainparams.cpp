...
static const int SCRYPT_SCRATCHPAD_SIZE = 166688 + 63;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
      ...
      (14000, uint256("0x18d8e725eab8e855c684e925640883090024f78a9f284af78b3842da04bf4982"))
      (15000, uint256("0x3e2a5f9991e005827dc989547596f39150bc5b59554fe55fffeddb4dda6ab6b2"))
      (18000,uint256("0xb2c3cbf00988159f01a40724be619208e0cc4b2d09df59e74df76c8f3ebbc68f"))
      (20000,uint256("0xbebcafb4911dc62fa275407fca13eeeeff357a00418c36fdbc42b6f4624d9513"))
      (30000,uint256("0xe2297149725d93c6f23d9eb898eae185cf92d2fd6f7183b116bdf2e308e09e87"))
      (40000,uint256("0xa9c924d8a9b266db84d34c429bc875fed81cfe3f716a4c60e3ccf8048e452927"))
      (50000,uint256("0xeef108f288467c95f778f7f3024011d45743043caa49d2d6b71bf1aa325d21db"))
      (60000,uint256("0x513582acc107fe4cba507e8e6a9be871f2d37b53c7c8878bae1c48505769dbbc"))

      ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553501704, // * UNIX timestamp of last checkpoint block
    65000, // * total number of transactions between genesis and last checkpoint
                //   (the tx=... number in the SetBestChain debug.log lines)
            // * estimated number of transactions per day after checkpoint
};

static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x000002dc60cd57672b0e7bf2d17f4d75a1d4e895e77987523103e0bbe61c258b"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0x3f0533cd28408f4c06c1726bbbaa400038ed4c62eb6d1d841edc85b378b3251f"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 16889;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Peony starting difficulty is the lowest possible 1 / 2^12
...
/*
        if (genesis.GetHash() != uint256("0x00000d7547bc34273b08721bea1230f5c4aad3e134d40a10de51b80c78876209"));
        {
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Peony: 1 day
        nTargetSpacing = 1 * 60;  // Peony: 1 minute
        nLastPOWBlock = 2;
        nMaturity = 5;
        ...
        hashGenesisBlock = genesis.GetHash();
/*        if(genesis.GetHash() != uint256("0x000002dc60cd57672b0e7bf2d17f4d75a1d4e895e77987523103e0bbe61c258b"))
        {
...
*/
        ...
        strSporkKey = "04bfe44aa466e8c9a39228dd72e24551bbdaedcff8a3c78da593487d372f8850ed21d542f81dc68de3d2c12fe4685692c5e2fc660caa8c6fb11b146ff0f00d4f2f";
        strObfuscationPoolDummyAddress = "PLzBQLMnZ4KhtLZvzMqwFR98AcvhZnoSsB";
        nStartMasternodePayments = 1549653940; //Fri, 09 Jan 2015 21:05:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Peony: 1 day
        nTargetSpacing = 1 * 60;        // Peony: 1 minutes
...
/*
       if(genesis.GetHash() != uint256("0x3f0533cd28408f4c06c1726bbbaa400038ed4c62eb6d1d841edc85b378b3251f"))
        {
            printf("MSearching for genesis block...\n");
            uint256 hashTarget;
            hashTarget.SetCompact(genesis.nBits);
