...
int nAnonymizepeonyAmount = 1000;
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "peony" is a composite category enabling all peony-related debug output
            if (ptrCategory->count(string("peony"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "peony.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "peonyd.pid"));
