...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"peony", "masternodelist", &masternodelist, true, true, false},
        {"peony", "mnbudget", &mnbudget, true, true, false},
        {"peony", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"peony", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peony", "mnsync", &mnsync, true, true, false},
        {"peony", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"peony", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use peonyd, or the -server option to peony-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
