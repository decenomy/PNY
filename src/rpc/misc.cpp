...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"zPNYsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zPNY denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zPNY denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zPNY denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zPNY denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zPNY denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zPNY denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zPNY denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zPNY denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zPNY denominations\n"
            "  }\n"
    ...
    UniValue zpnyObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        if (mapZerocoinSupply.empty())
            zpnyObj.push_back(Pair(std::to_string(denom), ValueFromAmount(0)));
        else
            zpnyObj.push_back(Pair(std::to_string(denom), ValueFromAmount(mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zpnyObj.push_back(Pair("total", ValueFromAmount(GetZerocoinSupply())));
    obj.push_back(Pair("zPNYsupply", zpnyObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\" : \"pnyaddress\",    (string) The pny address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for PNY cold staking\n"
...
UniValue getstakingstatus(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"staking_enabled\": true|false,     (boolean) whether staking is enabled/disabled in pny.conf\n"
            "  \"coldstaking_enabled\": true|false, (boolean) whether cold-staking is enabled/disabled in pny.conf\n"
