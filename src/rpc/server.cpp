...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PNY features */
        {"pny", "listmasternodes", &listmasternodes, true },
        {"pny", "getmasternodecount", &getmasternodecount, true },
        {"pny", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"pny", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"pny", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"pny", "masternodecurrent", &masternodecurrent, true },
        {"pny", "startmasternode", &startmasternode, true },
        {"pny", "createmasternodekey", &createmasternodekey, true },
        {"pny", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"pny", "listmasternodeconf", &listmasternodeconf, true },
        {"pny", "getmasternodestatus", &getmasternodestatus, true },
        {"pny", "getmasternodewinners", &getmasternodewinners, true },
        {"pny", "getmasternodescores", &getmasternodescores, true },
        {"pny", "preparebudget", &preparebudget, true },
        {"pny", "submitbudget", &submitbudget, true },
        {"pny", "mnbudgetvote", &mnbudgetvote, true },
        {"pny", "getbudgetvotes", &getbudgetvotes, true },
        {"pny", "getnextsuperblock", &getnextsuperblock, true },
        {"pny", "getbudgetprojection", &getbudgetprojection, true },
        {"pny", "getbudgetinfo", &getbudgetinfo, true },
        {"pny", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"pny", "mnfinalbudget", &mnfinalbudget, true },
        {"pny", "checkbudgets", &checkbudgets, true },
        {"pny", "mnsync", &mnsync, true },
        {"pny", "spork", &spork, true },
        ...
        {"zerocoin", "getzpnyseed", &getzpnyseed, false },
        {"zerocoin", "setzpnyseed", &setzpnyseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzpny", &searchdzpny, false },
        {"zerocoin", "dzpnystate", &dzpnystate, false },
