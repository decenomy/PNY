...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PNY features */
        {"pny", "masternode", &masternode, true, true, false},
        {"pny", "listmasternodes", &listmasternodes, true, true, false},
        {"pny", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pny", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pny", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pny", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pny", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pny", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pny", "masternodedebug", &masternodedebug, true, true, false},
        {"pny", "startmasternode", &startmasternode, true, true, false},
        {"pny", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pny", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pny", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pny", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pny", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pny", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pny", "mnbudget", &mnbudget, true, true, false},
        {"pny", "preparebudget", &preparebudget, true, true, false},
        {"pny", "submitbudget", &submitbudget, true, true, false},
        {"pny", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pny", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pny", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pny", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pny", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pny", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pny", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pny", "checkbudgets", &checkbudgets, true, true, false},
        {"pny", "mnsync", &mnsync, true, true, false},
        {"pny", "spork", &spork, true, true, false},
        {"pny", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpnyseed", &getzpnyseed, false, false, true},
        {"zerocoin", "setzpnyseed", &setzpnyseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpny", &searchdzpny, false, false, true},
        {"zerocoin", "dzpnystate", &dzpnystate, false, false, true},
...
{
    return "> pny-cli " + methodname + " " + args + "\n";
}
