...
// Copyright (c) 2015-2018 The peony developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* peony features */
        {"peony", "masternode", &masternode, true, true, false},
        {"peony", "listmasternodes", &listmasternodes, true, true, false},
        {"peony", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peony", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peony", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"peony", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"peony", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"peony", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peony", "masternodedebug", &masternodedebug, true, true, false},
        {"peony", "startmasternode", &startmasternode, true, true, false},
        {"peony", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peony", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peony", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peony", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peony", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peony", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peony", "mnbudget", &mnbudget, true, true, false},
        {"peony", "preparebudget", &preparebudget, true, true, false},
        {"peony", "submitbudget", &submitbudget, true, true, false},
        {"peony", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peony", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peony", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peony", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peony", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peony", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peony", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peony", "checkbudgets", &checkbudgets, true, true, false},
        {"peony", "mnsync", &mnsync, true, true, false},
        {"peony", "spork", &spork, true, true, false},
        {"peony", "getpoolinfo", &getpoolinfo, true, true, false},
