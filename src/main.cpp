...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 4044523) {
        ...
        int64_t mNodeCoins = mnodeman.size() * 2000 * COIN; // Collateral needed to run a single Peony Masternode
...
int ActiveProtocol()
{
    ...
    // SPORK_15 is used for 80014. Nodes < 80014 don't see it and still get their protocol version via SPORK_14 and their
