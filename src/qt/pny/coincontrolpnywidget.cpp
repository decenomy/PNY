...
#include "qt/pny/coincontrolpnywidget.h"
#include "qt/pny/forms/ui_coincontrolpnywidget.h"

CoinControlPnyWidget::CoinControlPnyWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlPnyWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select PNY Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("PNY");
    ...
    ui->labelValueAfter->setText("0.00 PNY");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 PNY");
    ui->labelValueFee->setText("0.00 PNY");
...
CoinControlPnyWidget::~CoinControlPnyWidget()
{
    delete ui;
}
