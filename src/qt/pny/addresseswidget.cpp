...
#include "qt/pny/forms/ui_addresseswidget.h"
#include "qt/pny/addresslabelrow.h"
#include "qt/pny/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(PNYGUI* parent) :
    PWidget(parent),
