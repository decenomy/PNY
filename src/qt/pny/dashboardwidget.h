...
#include "config/pny-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalPny = 0;
    qint64 totalZpny = 0;
    QList<qreal> valuesPny;
    QList<qreal> valueszPny;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(PNYGUI* _window);
    ~DashboardWidget();
