...
#include "qt/pny/settings/settingsnetworkwidget.h"
#include "qt/pny/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/pny/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PNYGUI* _window, QWidget *parent) :
