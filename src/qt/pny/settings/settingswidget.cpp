...
#include "qt/pny/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(PNYGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &PNYGUI::openFAQ);
