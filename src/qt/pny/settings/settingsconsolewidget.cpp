...
#include "qt/pny/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/pny/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PNYGUI* _window, QWidget *parent) :
