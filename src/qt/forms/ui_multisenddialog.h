...
public:
    ...
    void setupUi(QDialog *MultiSendDialog)
    {
        ...
        message->setGeometry(QRect(290, 230, 351, 91));
        ...
        addressBookButton->setGeometry(QRect(570, 190, 28, 21));
        QIcon icon;
        ...
        label->setGeometry(QRect(30, 160, 121, 20));
        label_5 = new QLabel(MultiSendDialog);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(30, 190, 111, 16));
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 130, 374, 25));
    ...
    void retranslateUi(QDialog *MultiSendDialog)
    {
        ...
        label_2->setText(QApplication::translate("MultiSendDialog", "MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other peony addresses after it matures.\n"
