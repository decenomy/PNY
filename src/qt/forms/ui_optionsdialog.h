...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizepeony = new QSpinBox(tabMain);
        anonymizepeony->setObjectName(QStringLiteral("anonymizepeony"));
        anonymizepeony->setMinimum(100);
        anonymizepeony->setMaximum(100000);
        anonymizepeony->setSingleStep(100);
        anonymizepeony->setValue(1000);

        horizontalLayout->addWidget(anonymizepeony);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start peony after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start peony on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of peony to keep anonymized", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the peony client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the peony network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting peony.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/peony-project/peony-project-translations", Q_NULLPTR));
