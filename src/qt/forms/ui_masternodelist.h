...
public:
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        updateNote->setOpenExternalLinks(true);
        updateNote->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(updateNote);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        updateNote->setText(QApplication::translate("MasternodeList", "<html><head/><body><p><span style=\" font-weight:600;\">Note: </span>Status of your masternodes in local wallet can potentially be slightly incorrect.<br/>Always wait for wallet to sync additional data and then double check from another node<br/>if your node should be running but you still see &quot;MISSING&quot; in &quot;Status&quot; field.</p></body></html>", Q_NULLPTR));
