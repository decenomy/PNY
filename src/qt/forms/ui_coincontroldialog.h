...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PNY"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PNY"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PNY"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PNY"));
