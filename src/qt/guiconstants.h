...
#define COLOR_UNCONFIRMED QColor(112,101,67)
...
#define QAPP_ORG_NAME "PNY"
#define QAPP_ORG_DOMAIN "pny.org"
#define QAPP_APP_NAME_DEFAULT "PNY-Qt"
#define QAPP_APP_NAME_TESTNET "PNY-Qt-testnet"
