...
QT_TRANSLATE_NOOP("pny-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("pny-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("pny-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("pny-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("pny-core", "Cannot write default address"),
...
QT_TRANSLATE_NOOP("pny-core", "Collateral not valid."),
...
QT_TRANSLATE_NOOP("pny-core", "Copyright (C) 2009-%i The Bitcoin Core Developers"),
QT_TRANSLATE_NOOP("pny-core", "Copyright (C) 2014-%i The Dash Core Developers"),
...
QT_TRANSLATE_NOOP("pny-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("pny-core", "Enable publish raw transaction (locked via SwiftX) in <address>"),
QT_TRANSLATE_NOOP("pny-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("pny-core", "Enable staking functionality (0-1, default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Entries are full."),
QT_TRANSLATE_NOOP("pny-core", "Error connecting to Masternode."),
...
QT_TRANSLATE_NOOP("pny-core", "Error recovering public key."),
...
QT_TRANSLATE_NOOP("pny-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("pny-core", "Error: You already have pending entries in the Obfuscation pool"),
...
QT_TRANSLATE_NOOP("pny-core", "Finalizing transaction."),
QT_TRANSLATE_NOOP("pny-core", "Force safe mode (default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("pny-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("pny-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("pny-core", "Importing..."),
QT_TRANSLATE_NOOP("pny-core", "Imports blocks from external blk000??.dat file"),
QT_TRANSLATE_NOOP("pny-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("pny-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("pny-core", "Input is not valid."),
...
QT_TRANSLATE_NOOP("pny-core", "Invalid private key."),
QT_TRANSLATE_NOOP("pny-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("pny-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("pny-core", "Last successful Obfuscation action was too recent."),
...
QT_TRANSLATE_NOOP("pny-core", "Lock is already in place."),
...
QT_TRANSLATE_NOOP("pny-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("pny-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("pny-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("pny-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("pny-core", "Need address because change is not exact"),
QT_TRANSLATE_NOOP("pny-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("pny-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("pny-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("pny-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("pny-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("pny-core", "Node relay options:"),
QT_TRANSLATE_NOOP("pny-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("pny-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("pny-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("pny-core", "Not in the Masternode list."),
...
QT_TRANSLATE_NOOP("pny-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("pny-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("pny-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("pny-core", "RPC server options:"),
QT_TRANSLATE_NOOP("pny-core", "Randomly drop 1 of every <n> network messages"),
...
QT_TRANSLATE_NOOP("pny-core", "Session not complete!"),
...
QT_TRANSLATE_NOOP("pny-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("pny-core", "Set minimum block size in bytes (default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Set the Maximum reorg depth (default: %u)"),
QT_TRANSLATE_NOOP("pny-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("pny-core", "Set the number of threads to service RPC calls (default: %d)"),
...
QT_TRANSLATE_NOOP("pny-core", "Signing failed."),
...
QT_TRANSLATE_NOOP("pny-core", "Specify data directory"),
QT_TRANSLATE_NOOP("pny-core", "Specify masternode configuration file (default: %s)"),
...
QT_TRANSLATE_NOOP("pny-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("pny-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("pny-core", "Submitted to masternode, waiting in queue %s"),
...
QT_TRANSLATE_NOOP("pny-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("pny-core", "Transaction Created"),
...
QT_TRANSLATE_NOOP("pny-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("pny-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("pny-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("pny-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("pny-core", "Transaction too large"),
QT_TRANSLATE_NOOP("pny-core", "Transmitting final transaction."),
...
QT_TRANSLATE_NOOP("pny-core", "Unable to find transaction containing mint"),
...
QT_TRANSLATE_NOOP("pny-core", "Unknown state: id = %u"),
...
QT_TRANSLATE_NOOP("pny-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("pny-core", "Value is below the smallest available denomination (= 1) of zPNY"),
QT_TRANSLATE_NOOP("pny-core", "Value more than Obfuscation pool maximum allows."),
...
QT_TRANSLATE_NOOP("pny-core", "Wallet is locked."),
...
QT_TRANSLATE_NOOP("pny-core", "Warning: This version is obsolete, upgrade required!"),
QT_TRANSLATE_NOOP("pny-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("pny-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("pny-core", "Will retry..."),
QT_TRANSLATE_NOOP("pny-core", "You don't have enough Zerocoins in your wallet"),
QT_TRANSLATE_NOOP("pny-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("pny-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("pny-core", "Your transaction was accepted into the pool!"),
