...
/** Utility functions used by the PNY Qt UI.
 */
namespace GUIUtil
{
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZpny = false);
...
// Parse "pny:" URI into recipient object, return true on successful parsing
