                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Peony Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a peony address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peony: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Peony Client"), this);
    aboutAction->setStatusTip(tr("Show information about Peony Client"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for peony"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your peony addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified peony addresses"));
    ...
    openAction->setStatusTip(tr("Open a peony: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Peony Client help message to get a list with possible peony command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Peony Client client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to peony network", "", count));
}
...
{
    QString strTitle = tr("Peony Client"); // default title
