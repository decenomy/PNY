...
bool CLegacyZPnyStake::InitFromTxIn(const CTxIn& txin)
{
...
CLegacyZPnyStake::CLegacyZPnyStake(const libzerocoin::CoinSpend& spend)
{
...
CBlockIndex* CLegacyZPnyStake::GetIndexFrom()
{
...
CAmount CLegacyZPnyStake::GetValue() const
{
    return denom * COIN;
}

CDataStream CLegacyZPnyStake::GetUniqueness() const
{
