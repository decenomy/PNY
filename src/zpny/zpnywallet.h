...
#ifndef PNY_ZPNYWALLET_H
#define PNY_ZPNYWALLET_H
...
public:
    ...
    void GenerateDeterministicZPNY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPNY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
