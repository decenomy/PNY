 ...
 * PNY system. There are three: the main network on which people trade goods
...
public:
    ...
    int PnyBadBlockTime() const { return nPnyBadBlockTime; }
    int PnyBadBlocknBits() const { return nPnyBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nPnyBadBlockTime;
    unsigned int nPnyBadBlocknBits;
