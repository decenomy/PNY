Peony Client version 2.2.1 is now available from:

  <https://github.com/peony-project/peony/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/peony-project/peony/issues>

Compatibility
==============

Peony Client is extensively tested on multiple operating systems using
...
Peony Client should also work on most other Unix-like systems but is not
...
of Bitcoin that peony was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/peony-project-translations/).
