...
This mechanism has been integrated into Bitcore-Node-PNY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PeonyTeam/insight-api-pny#web-socket-api](https://github.com/PeonyTeam/insight-api-pny#web-socket-api) 
* API: [https://github.com/PeonyTeam/insight-api-pny#swifttx-transactions](https://github.com/PeonyTeam/insight-api-pny#swifttx-transactions) 
...
By default, the PNY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PNY Core daemon:
