...
This mechanism has been integrated into Bitcore-Node-peony which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/peony-Project/insight-api-peony#web-socket-api](https://github.com/peony-Project/insight-api-peony#web-socket-api)
* API: [https://github.com/peony-Project/insight-api-peony#swifttx-transactions](https://github.com/peony-Project/insight-api-peony#swifttx-transactions)
...
By default, the Peony Client daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Peony Client daemon:
