...
In order to support loading of multiple wallets in pny-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pny.cpp.
...
Changes to pny.cpp
----------------------
pny.cpp is the entry point into pny-qt, and as such, will require some minor modifications to provide hooks for
