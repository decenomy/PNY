...
In order to support loading of multiple wallets in peony-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peony.cpp.
...
Changes to peony.cpp
----------------------
peony.cpp is the entry point into peony-qt, and as such, will require some minor modifications to provide hooks for
