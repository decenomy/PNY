...
- [Development guidelines](#development-guidelines)
    - [General PNY Core](#general-pny-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
PNY Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
PNY Core is a multi-threaded application, and deadlocks or other
...
However, in open source software such as PNY Core, where everyone uses
...
pay attention to for reviewers of PNY Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PNY Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against PNY Core so that they can be integrated
