...
1. Clone the PNY Core source code:

        git clone https://github.com/PeonyTeam/pny
        cd pny
...
PNY Core is now available at `./src/pnyd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PNY"

    touch "/Users/${USER}/Library/Application Support/PNY/pny.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PNY/pny.conf"

The first time you run pnyd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/pnyd -daemon # Starts the pny daemon.
    ./src/pny-cli --help # Outputs a list of command-line options.
    ./src/pny-cli help # Outputs a list of RPC commands when the daemon is running.
