...
pny.conf           | contains configuration settings for pnyd or pny-qt
pnyd.pid           | stores the process id of pnyd while running
...
debug.log           | contains debug information and general logging generated by pnyd or pny-qt
