...
The build script we'll be using is contained in the PNY github repository ([contrib/gitian-build.py](https://github.com/PeonyTeam/pny/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the PNY repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/PeonyTeam/PNY/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, pny-detached-sigs, and pny GitHub repos.
