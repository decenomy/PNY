...
The script [extract-osx-sdk.sh](https://github.com/PeonyTeam/pny/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
pny/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/PeonyTeam/pny/blob/master/doc/README_osx.md) for troubleshooting tips.