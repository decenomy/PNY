...
RESOURCES += src/qt/peony.qrc src/qt/peony_locale.qrc

TRANSLATIONS += src/qt/locale/peony_bg.ts \
                src/qt/locale/peony_de.ts \
                src/qt/locale/peony_en.ts \
                src/qt/locale/peony_es.ts \
                src/qt/locale/peony_fi.ts \
                src/qt/locale/peony_fr.ts \
                src/qt/locale/peony_it.ts \
                src/qt/locale/peony_ja.ts \
                src/qt/locale/peony_pl.ts \
                src/qt/locale/peony_pt.ts \
                src/qt/locale/peony_ru.ts \
                src/qt/locale/peony_sk.ts \
                src/qt/locale/peony_sv.ts \
                src/qt/locale/peony_vi.ts \
                src/qt/locale/peony_zh_CN.ts \
                src/qt/locale/peony_zh_TW.ts
