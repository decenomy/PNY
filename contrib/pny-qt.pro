...
RESOURCES += src/qt/pny.qrc src/qt/pny_locale.qrc

TRANSLATIONS += src/qt/locale/pny_bg.ts \
                src/qt/locale/pny_de.ts \
                src/qt/locale/pny_en.ts \
                src/qt/locale/pny_es.ts \
                src/qt/locale/pny_fi.ts \
                src/qt/locale/pny_fr.ts \
                src/qt/locale/pny_it.ts \
                src/qt/locale/pny_ja.ts \
                src/qt/locale/pny_pl.ts \
                src/qt/locale/pny_pt.ts \
                src/qt/locale/pny_ru.ts \
                src/qt/locale/pny_sk.ts \
                src/qt/locale/pny_sv.ts \
